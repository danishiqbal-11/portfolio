...
import { Container, Button, Card, Tab, Tabs } from 'react-bootstrap';
...
const DSA = () => {
  ...
  return (
    <Container className="py-5">
      <h2 className="text-center mb-4">Data Structure and Algorithms</h2>
      <Tabs defaultActiveKey="arrays" id="dsa-tabs" className="mb-3 justify-content-center">
        <Tab eventKey="arrays" title="Arrays">
          <Card className="mb-3">
            <Card.Body>
        ...
        {/* Add more tabs for other DSA topics here */}
      </Tabs>
    </Container>
  );
};
